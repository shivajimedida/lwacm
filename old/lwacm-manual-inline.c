...
void do_iteration(double*** p_now,double*** p_next,double****u_now,double****u_next)
{
  int x,y,z;
  // array to store f
  double f[19];
  ...
  double u_xi;    // u(x-xi) * xi
  double u_x_xi;  // u(x) * xi
  double u_2;     // u square

  double f_e;     // f(e)
  double f_e_o;   // f(e, o)(x-xi_alpha, t)
  double f_x_t;   // f(e, o)(x, t)
...
//#pragma ivdep
	...
	// alpha1_call()
      ...
      u_load[0] = u_now[x][y][0][z];
      u_load[1] = u_now[x][y][1][z];
      u_load[2] = u_now[x][y][2][z];
      ...
      f_x_t = 3.0 * 1.0/3.0 * p_now[x][y][z] * u_x_xi;
	...
	// alpha1_call()
      ...
      //load p(x-xia) and u(x-xia)
      p_load = p_now[x-1][y][z];

      u_load[0] = u_now[x-1][y][0][z];
      u_load[1] = u_now[x-1][y][1][z];
      u_load[2] = u_now[x-1][y][2][z];

      u_xi = u_load[0];
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z];
      ...
      // step 8.5, compute f(e, o)(x, t)
      f_x_t = 3.0 * 1.0/18.0 * p_now[x][y][z] * u_x_xi;
	...
	// alpha3_call()
      ...
      //load p(x-xia) and u(x-xia)
      p_load = p_now[x][y-1][z];

      u_load[0] = u_now[x][y-1][0][z];
      u_load[1] = u_now[x][y-1][1][z];
      u_load[2] = u_now[x][y-1][2][z];

      u_xi = u_load[1];
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][1][z];
	...
	// alpha5_call()
      ...
      //load p(x-xia) and u(x-xia)
      p_load = p_now[x][y][z-1];

      u_load[0] = u_now[x][y][0][z-1];
      u_load[1] = u_now[x][y][1][z-1];
      u_load[2] = u_now[x][y][2][z-1];

      u_xi = u_load[2];
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][2][z];
	...
	// alpha7_call()
      ...
      //load p(x-xia) and u(x-xia)
      p_load = p_now[x-1][y-1][z];

      u_load[0] = u_now[x-1][y-1][0][z];
      u_load[1] = u_now[x-1][y-1][1][z];
      u_load[2] = u_now[x-1][y-1][2][z];

      u_xi = u_load[0] + u_load[1];
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z] + u_now[x][y][1][z];
      ...
      // step 8.5, compute f(e, o)(x, t)
      f_x_t = 3.0 * 1.0/36.0 * p_now[x][y][z] * u_x_xi;
	...
	// alpha8_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z] * (-1) + u_now[x][y][1][z];
	...
	// alpha9_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z] + u_now[x][y][1][z] * (-1);
	...
	// alpha10_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z] * (-1) + u_now[x][y][1][z] * (-1);
	...
	// alpha11_call()
      ...
      //load p(x-xia) and u(x-xia)
      p_load = p_now[x-1][y][z-1];

      u_load[0] = u_now[x-1][y][0][z-1];
      u_load[1] = u_now[x-1][y][1][z-1];
      u_load[2] = u_now[x-1][y][2][z-1];

      u_xi = u_load[0] + u_load[2];
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z] + u_now[x][y][2][z];
	...
	// alpha12_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z] * (-1) + u_now[x][y][2][z];
	...
	// alpha13_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z] + u_now[x][y][2][z] * (-1);
	...
	// alpha14_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][0][z] * (-1) + u_now[x][y][2][z] * (-1);
	...
	// alpha15_call()
      ...
      //load p(x-xia) and u(x-xia)
      p_load = p_now[x][y-1][z-1];

      u_load[0] = u_now[x][y-1][0][z-1];
      u_load[1] = u_now[x][y-1][1][z-1];
      u_load[2] = u_now[x][y-1][2][z-1];

      u_xi = u_load[1] + u_load[2];
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][1][z] + u_now[x][y][2][z];
	...
	// alpha16_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][1][z] * (-1) + u_now[x][y][2][z];
	...
	// alpha17_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][1][z] + u_now[x][y][2][z] * (-1);
	...
	// alpha18_call()
      ...
      u_2  = u_load[0] * u_load[0] + u_load[1] * u_load[1] + u_load[2] * u_load[2];
      u_x_xi = u_now[x][y][1][z] * (-1) + u_now[x][y][2][z] * (-1);
      ...
      /* ============================================================ */
                ...
                u_next[x][y][0][z] = ( f[1]-f[2]+f[7]-f[8]+f[9]-f[10]+f[11]-f[12]+f[13]-f[14] )/p_load;
                u_next[x][y][1][z] = ( f[3]-f[4]+f[7]+f[8]-f[9]-f[10]+f[15]-f[16]+f[17]-f[18] )/p_load;
                u_next[x][y][2][z] = ( f[5]-f[6]+f[11]+f[12]-f[13]-f[14]+f[15]+f[16]-f[17]-f[18] )/p_load;
            }
          }
        }
}
...
int main( int argc, char *argv[] )
{
    ...
    for( t = 0; t < T_MAX; t++)
    {
        do_iteration(p[t_now],p[t_next],u[t_now],u[t_next]);
